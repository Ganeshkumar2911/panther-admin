...
export const useTelegramSettingsStore = defineStore("telegramSettings", () => {
  ...
  const fetchSettings = (force = false, page = 1, filters = {}) => {
    ...
    apiRequest(urls.KEYS.GET, urls.dev_telegram.list, {
      params: {
        page,
  ...
  const createSetting = (formData, onDone) => {
    ...
    apiRequest(urls.KEYS.POST, urls.dev_telegram.create, {
      data: formData,
      isTokenRequired: true,
      onSuccess: successHandler,
      onFailure: failureHandler,
  ...
  const updateSetting = (id, formData, onDone) => {
    ...
    apiRequest(urls.KEYS.PUT, urls.dev_telegram.update, {
      look_up_key: id,
      data: formData,
      isTokenRequired: true,
      onSuccess: successHandler,
  ...
  const deleteSetting = (id, onDone) => {
    ...
    apiRequest(urls.KEYS.DELETE, urls.dev_telegram.delete, {
      look_up_key: id,
      isTokenRequired: true,
      onSuccess: successHandler,
      onFailure: failureHandler,
