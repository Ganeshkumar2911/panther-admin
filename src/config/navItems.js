    ...
    children: [
      {
        ...
        icon: ShieldCheck,
        permission: ["ib_commission_approvals.view", "ib_commission.approvals.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: Coins,
        permission: ["ib_commission_commissions.view", "ib_commission.commissions.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: LineChart,
        permission: ["ib_commission_trades.view", "ib_commission.trades.view", "ib_commission.view"],
      ...
      },
      {
        ...
        permission: ["ib_commission_rates.view", "ib_commission.rates.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: FolderTree,
        permission: ["ib_commission_symbol_groups.view", "ib_commission.symbol_groups.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: Database,
        permission: ["ib_commission_sync.view", "ib_commission.sync.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: Wallet,
        permission: ["ib_commission_demo_wallets.view", "ib_commission.demo_wallets.view", "ib_commission.view"],
      ...
      },
      {
        ...
        icon: Settings,
        permission: ["ib_commission_settings.view", "ib_commission.settings.view", "ib_commission.view"],
