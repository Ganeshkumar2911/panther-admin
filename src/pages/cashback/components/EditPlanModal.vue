  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
    <div class="bg-card-background border border-primary-border rounded-xl shadow-lg w-full max-w-sm overflow-hidden flex flex-col">
      ...
      <div class="p-5 space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-secondary-text mb-1">Rate per Lot</label>
          <input v-model="formData.rate_per_lot" type="number" step="0.01" min="0" class="input-field px-3 py-2 text-sm w-full" />
        </div>
      </div>
