...
<template>
  <div class="space-y-4 pb-48">
    ...
    <div class="rounded-lg bg-card-background/80 backdrop-blur-xl border border-primary-border/50 overflow-hidden">
      ...
      <div class="p-4 sm:p-5 border-b border-primary-border flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-background/40">
        ...
        <button
          ...
          @click="store.fetchRecalcRevertMaster(true)"
        >
          ...
          <div class="p-3 rounded-lg bg-background/60 border border-primary-border/50 backdrop-blur-sm">
            <div class="flex items-center justify-between mb-0.5">
              ...
              <span
                ...
                class="px-1.5 py-0.2 rounded text-[10px] font-semibold"
                :class="getMasterStateBadge(masterSummary.night_master_state).class"
              >
          ...
          <div class="flex items-center justify-between gap-2 border-b border-primary-border pb-3">
            <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <p class="text-xs text-secondary-text">Live settings for IB #{{ selectedIbId }}</p>
              </div>
            </div>
    ...
    <!-- ═════════════════════════════════════════════════════════════ -->
    <!-- SECTION 2: GLOBAL DAILY RUN & ON-DEMAND ENGINE (COMMENTED OUT)  -->
    <!-- ═════════════════════════════════════════════════════════════ -->
    <!--
    <div class="rounded-lg bg-card-background/80 backdrop-blur-xl border border-primary-border/50 p-4 sm:p-5 space-y-4">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-primary-border pb-3">
        <div>
          <h3 class="text-sm font-bold text-primary-text flex items-center gap-2">
            <HugeIcon :icon="PlayIcon" :size="16" class="text-primary" />
            <span>Daily Run &amp; On-Demand Recalculation Engine</span>
          </h3>
          <p class="text-xs text-secondary-text mt-0.5">
        ...
        <div v-if="canManageSettings" class="flex items-center gap-2 shrink-0">
          <button
            type="button"
