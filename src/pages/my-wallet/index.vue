      ...
      <template v-else>
        ...
        >
          ...
          <p class="text-2xl font-medium text-green-700">
            +${{ formatNum(store.summary.total_earnings) }}
          </p>
        </div>
        <div
          class="bg-card-background border border-primary-border rounded-xl p-4"
        >
          ...
          <p class="text-2xl font-medium text-primary-text">
            ${{ formatNum(store.summary.total_broker_fee) }}
          </p>
        </div>
        <div
          class="bg-card-background border border-primary-border rounded-xl p-4"
        >
          ...
          <p class="text-2xl font-medium text-primary-text">
            ${{ formatNum(store.summary.total_platform_earning) }}
          </p>
        </div>
      </template>
    </div>
      ...
      <table class="w-full border-collapse">
        ...
        <tbody v-if="store.loading">
          ...
          >
            ...
            <td class="p-3">
              <div class="h-5 w-24 bg-card-background rounded-full" />
            </td>
            <td class="p-3">
        ...
        <tbody v-else>
          ...
          >
            ...
            <td class="p-3 text-xs text-secondary-text max-w-[180px] truncate">
              {{ entry.description ?? "—" }}
            </td>
...
import { BookOpen, FolderUp } from "lucide-vue-next";
...
const typeClass = (type) =>
  ({
    broker_fee: "bg-primary-blue/50 border-blue-200",
    platform_earning: "bg-primary-green/50 border-green-200",
