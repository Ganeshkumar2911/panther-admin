  ...
  <div class="px-4">
    ...
    <div v-if="activeTab === 'your-tickets'" class="space-y-5">
      ...
      >
        ...
        >
          ...
          <BaseSelect
            ...
            @update:modelValue="
              (val) => yourTicketsStore.updatePerPage(val, yourTicketsFilters)
            "
          />
          ...
          <Tooltip text="Export" position="left">
            <button
              type="button"
              :disabled="yourTicketsStore.isExporting"
              class="inline-flex items-center cursor-pointer justify-center rounded-lg border border-primary-border p-2 text-secondary-text transition-colors hover:text-primary-text hover:bg-background disabled:opacity-60 disabled:cursor-not-allowed"
              @click="yourTicketsStore.exportTickets(yourTicketsFilters)"
            >
              <FolderUp
                class="w-3.5 h-3.5"
                :class="{ 'animate-spin': yourTicketsStore.isExporting }"
              />
            </button>
          </Tooltip>
        </div>
          ...
          <tbody v-if="yourTicketsStore.isLoading">
            ...
            >
              ...
              <td class="p-3 flex justify-end">
                <div class="h-8 w-8 bg-card-background rounded-lg" />
              </td>
            </tr>
          </tbody>
          ...
          <tbody v-else>
            ...
            >
              ...
              <td class="p-3 text-right">
                ...
                >
                  <button
                    class="w-8 h-8 inline-flex items-center justify-center rounded-lg border border-primary-border hover:bg-background transition-colors group"
                  >
                    <Eye
                      class="w-4 h-4 text-secondary-text group-hover:text-primary-text"
                    />
                  </button>
                </RouterLink>
              </td>
      ...
      <div class="mt-4">
        <Pagination
          v-if="
            yourTicketsStore.pagination.total_items >
            yourTicketsStore.pagination.per_page
          "
      ...
      <div class="relative z-10">
        ...
        >
          ...
          <Tooltip text="Export" position="left">
            <button
              type="button"
              :disabled="platformTicketsStore.isExporting"
              class="inline-flex items-center justify-center rounded-lg border border-primary-border p-2 text-secondary-text transition-colors hover:text-primary-text hover:bg-background disabled:opacity-60 disabled:cursor-not-allowed"
              @click="platformTicketsStore.exportTickets"
            >
              <FolderUp
                class="w-3.5 h-3.5"
                :class="{ 'animate-spin': platformTicketsStore.isExporting }"
              />
            </button>
          </Tooltip>
