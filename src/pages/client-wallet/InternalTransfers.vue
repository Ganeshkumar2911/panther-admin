      ...
      >
        ...
        <Tooltip text="Export" position="right">
          <button
            ...
            class="rounded-lg p-2 text-secondary-text hover:bg-background hover:text-primary-text transition-colors border border-primary-border disabled:opacity-60 disabled:cursor-not-allowed"
            @click="store.exportTransfers"
          >
        ...
        <tbody v-else>
          ...
          >
            ...
            <td class="p-3">
              ...
              <p
                class="text-[10px] text-secondary-text max-w-[250px] truncate"
