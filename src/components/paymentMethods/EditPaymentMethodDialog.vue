  ...
  <Transition name="slide">
    <div v-if="open" class="fixed inset-0 z-40 flex">
      ...
      >
        ...
        <div
          class="px-6 pt-3 flex border-b border-primary-border bg-background/10 gap-2 shrink-0"
        >
          <button
            v-for="tab in [
        ...
        <div class="flex-1 overflow-y-auto px-6 py-5 space-y-4 no-scrollbar">
          ...
          <div
            v-if="isEdit"
            class="grid grid-cols-2 gap-3 bg-background/40 p-3 rounded-xl border border-primary-border/30"
          >
            <div>
              <p
                class="text-[10px] text-secondary-text uppercase tracking-wider mb-0.5"
              >
                Gateway / Method Type
              </p>
            ...
            <div v-if="paymentMethod?.wallet_id">
              ...
              <p
                class="text-xs font-mono text-primary-text truncate"
                :title="paymentMethod?.wallet_id"
              >
          ...
          <div>
            <label class="block text-xs font-medium text-secondary-text mb-1.5"
              >Wallet Label <span class="text-primary-red">*</span></label
            >
            <input
          ...
          <div v-if="activeTab === 'bank'" class="space-y-4 pt-2">
            <h3
              class="text-xs font-semibold uppercase tracking-wider text-secondary-text border-b border-primary-border/50 pb-1.5"
            >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label
                  ...
                  >Bank Name <span class="text-primary-red">*</span></label
                >
                <input
              ...
              <div>
                <label
                  class="block text-xs font-medium text-secondary-text mb-1.5"
                  >Account Name <span class="text-primary-red">*</span></label
                >
                <input
              ...
              <div>
                <label
                  class="block text-xs font-medium text-secondary-text mb-1.5"
                  >Account Number <span class="text-primary-red">*</span></label
                >
                <input
              ...
              <div>
                <label
                  class="block text-xs font-medium text-secondary-text mb-1.5"
                  >IFSC Code <span class="text-primary-red">*</span></label
                >
                <input
          ...
          <div v-if="activeTab === 'upi'" class="space-y-4 pt-2">
            ...
            <div>
              <label
                class="block text-xs font-medium text-secondary-text mb-1.5"
                >UPI ID <span class="text-primary-red">*</span></label
              >
              <input
                v-model="form.upi_id"
                type="text"
          ...
          <div v-if="activeTab === 'crypto'" class="space-y-4 pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label
                  class="block text-xs font-medium text-secondary-text mb-1.5"
                  >Wallet ID / ID <span class="text-primary-red">*</span></label
                >
                <input
          ...
          <div class="space-y-4 pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                <label
                  class="block text-[11px] font-medium text-secondary-text mb-1.5"
                  >Min Deposit</label
                >
                <div class="relative">
                  <input
          ...
          <div class="space-y-4 pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div
                class="space-y-4 p-4 bg-background/20 rounded-xl border border-primary-border/30"
              >
                <span
                  class="text-[10px] font-bold uppercase tracking-wider text-secondary-text block"
                  >Deposit Settings</span
                >

                <!-- Enable Deposit -->
                <div class="flex items-center justify-between">
                  <span class="text-xs text-primary-text font-medium"
                    >Enable Deposit</span
                  >
                  <button
                    type="button"
                  ...
                  >
                    <span
                      ...
                      :class="
                        form.enable_deposit ? 'translate-x-5' : 'translate-x-0'
                      "
                    />
                  </button>
                </div>
              ...
              >
                <span
                  class="text-[10px] font-bold uppercase tracking-wider text-secondary-text block"
                  >Withdrawal Settings</span
                >

                <!-- Enable Withdrawal -->
                <div class="flex items-center justify-between">
                  <span class="text-xs text-primary-text font-medium"
                    >Enable Withdrawal</span
                  >
                  <button
                    type="button"
                    :disabled="submitting"
            ...
            >
              <div>
                ...
                <p class="text-[10px] text-secondary-text mt-0.5">
                  Control whether this payment method is visible and usable
                </p>
              </div>
              <button
                type="button"
            ...
            <div
              class="space-y-3 p-4 bg-background/20 rounded-xl border border-primary-border/30"
            >
              <div>
                <p class="text-xs font-semibold text-primary-text">
                  Withdrawal Notification Emails
                ...
                <p class="text-[10px] text-secondary-text mt-0.5">
                  Alerts will be sent to these emails upon withdrawal requests
                </p>
              </div>
              ...
              <!-- Input error message -->
              <p
                v-if="emailInputError"
                class="text-primary-red text-[11px] font-medium leading-none"
              >
                {{ emailInputError }}
              </p>
              ...
              <!-- Tags container -->
              <div
                v-if="form.withdraw_notification_emails?.length"
              ...
              <p
                v-else
                class="text-[11px] text-secondary-text italic text-center py-2"
              >
  ...
  (newVal) => {
    if (newVal) {
      ...
      if (props.paymentMethod) {
        ...
        const type =
          props.paymentMethod.method_type ||
          props.paymentMethod.gateway ||
          "crypto";
        ...
        form.value = {
          ...
          minimum_deposit_amount:
            props.paymentMethod.minimum_deposit_amount ?? 0,
          maximum_withdrawal_amount:
            props.paymentMethod.maximum_withdrawal_amount ?? 0,
          maximum_deposit_amount:
            props.paymentMethod.maximum_deposit_amount ?? 0,
          minimum_withdrawal_amount:
            props.paymentMethod.minimum_withdrawal_amount ?? 0,
          maximum_withdrawals_per_day:
            props.paymentMethod.maximum_withdrawals_per_day ?? null,
          ...
          is_default_withdrawal:
            props.paymentMethod.is_default_withdrawal ?? false,
          remarks: props.paymentMethod.remarks ?? "",
          is_active: props.paymentMethod.is_active ?? true,
          withdraw_notification_emails:
            props.paymentMethod.withdraw_notification_emails ?? [],
...
const isValid = computed(() => {
  ...
  if (
    ...
    return false;
  if (
    form.value.maximum_withdrawals_per_day !== null &&
    form.value.maximum_withdrawals_per_day !== ""
  ) {
  ...
  try {
    ...
    if (activeTab.value === "bank") {
      payload = {
        ...
        maximum_deposit_amount: Number(form.value.maximum_deposit_amount),
        minimum_withdrawal_amount: Number(form.value.minimum_withdrawal_amount),
