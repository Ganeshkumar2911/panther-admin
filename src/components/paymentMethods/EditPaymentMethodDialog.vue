    ...
    >
      ...
      <div class="px-6 py-4 border-t border-primary-border flex gap-3 bg-background/10">
        ...
        <button
          ...
          class="flex-1 px-4 py-2.5 rounded-lg text-xs font-semibold text-black bg-primary hover:bg-primary-hover transition-colors flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
          @click="submit"
        >
