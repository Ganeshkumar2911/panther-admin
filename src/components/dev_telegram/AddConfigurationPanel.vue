    ...
    <div v-if="open" class="fixed inset-0 z-40 flex">
      ...
      >
        ...
        >
          <button
            @click="$emit('close')"
            class="h-10 px-4 rounded-lg border border-primary-border text-secondary-text hover:text-primary-text hover:border-primary cursor-pointer transition-colors text-sm font-medium"
          >
            Cancel
          </button>
          ...
          <button
            ...
            class="h-10 px-6 rounded-lg cursor-pointer bg-primary text-white hover:bg-primary/90 disabled:opacity-50 transition-colors text-sm font-medium flex items-center gap-2"
          >
            <Plus class="w-4 h-4" />
